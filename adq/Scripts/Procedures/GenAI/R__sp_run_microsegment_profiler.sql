...
-- Extracted on: 2025-10-27 10:25:03
--------------------------------------------------------------------------------
CREATE OR REPLACE PROCEDURE RUN_MICROSEGMENT_PROFILER(
    "RUN_ID" VARCHAR,
    "MICROSEGMENT_DEF_ID" NUMBER(38, 0),
    "MICROSEGMENT_DEF_NAME" VARCHAR,
...
from snowflake.snowpark.functions import col, cast, call_udf
