...
CREATE OR REPLACE TABLE DQ_DATASETS_ERROR_INSIGHTS (
    ERROR_INSIGHT_ID NUMBER(38, 0) NOT NULL AUTOINCREMENT START 1 INCREMENT 1 NOORDER,
    DATASET_ID NUMBER(38, 0) NOT NULL,
    DATASET_RUN_ID NUMBER(38, 0) NOT NULL,
    RULE_CONFIG_ID NUMBER(38, 0) NOT NULL,
    EXPECTATION_NAME VARCHAR(16777216) NOT NULL,
    COLUMN_NAME VARCHAR(16777216) NOT NULL,
    RULE_NAME VARCHAR(16777216),
    ISSUE_SUMMARY VARCHAR(16777216),
    ...
    PRIMARY KEY (ERROR_INSIGHT_ID)
);

CREATE OR REPLACE TABLE DQ_DATASETS_ERROR_INSIGHTS_V2 (
    ERROR_INSIGHT_ID NUMBER(38, 0) NOT NULL AUTOINCREMENT START 1 INCREMENT 1 NOORDER,
    DATASET_ID NUMBER(38, 0) NOT NULL,
    DATASET_RUN_ID NUMBER(38, 0) NOT NULL,
    RULE_CONFIG_ID NUMBER(38, 0) NOT NULL,
...
CREATE OR REPLACE TABLE DQ_RESULTS_ANALYSIS (
    DATASET_ID NUMBER(38, 0) NOT NULL,
    DATASET_RUN_ID NUMBER(38, 0) NOT NULL,
    ERROR_INSIGHTS VARIANT,
    BUSINESS_IMPACT_INSIGHTS VARIANT,
    AGGREGATION_INSIGHTS VARIANT,
    INSIGHTS_GENERATION VARIANT,
    CREATED_AT TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP()
);
...
CREATE OR REPLACE TABLE PROFILER_ATTRIBUTE_STATS (
    ...
    COLUMN_ID NUMBER(38, 0),
    COLUMN_NAME VARCHAR(16777216) COLLATE 'en-ci',
    DATA_TYPE VARCHAR(16777216) COLLATE 'en-ci',
    COLUMN_INFERRED_DATA_TYPE VARCHAR(16777216) COLLATE 'en-ci',
...
CREATE OR REPLACE TRANSIENT TABLE TEMP_RESULT_329_42 (
    DATASET_RUN_ID NUMBER(2, 0),
    DATASET_ID NUMBER(3, 0),
    DATASET_NAME VARCHAR(16),
    EXPORT_TIMESTAMP TIMESTAMP_LTZ(9),
    "DV_KEI_RIEKI_Numeric_MEAN_RANGE_CHECK_2761" VARCHAR(4),
    DV_CODE_SQL_CUSTOM_RULE_2760 VARCHAR(4),
    DV_CODE VARCHAR(20),
    DV_NAME VARCHAR(200),
...
CREATE OR REPLACE TRANSIENT TABLE TEMP_RESULT_331_37 (
    DATASET_RUN_ID NUMBER(2, 0),
    DATASET_ID NUMBER(3, 0),
    DATASET_NAME VARCHAR(17),
    EXPORT_TIMESTAMP TIMESTAMP_LTZ(9),
    "COMPLIMENTARY_IND_Conformity_SET_INCLUSION_3390" VARCHAR(4),
    TRANSACTION_DT_KEY NUMBER(38, 0),
    TRANSACTION_DT VARCHAR(16777216),
    MARKETPLACE_TYPE_CD VARCHAR(16777216),
    TRANSACTION_YEAR_MONTH_CD VARCHAR(16777216),
    REGION_CD VARCHAR(16777216),
    BM_REPORTING_REGION_CD VARCHAR(16777216),
    BM_REPORTING_REGION_NM VARCHAR(16777216),
    RETAIL_DAY_NBR NUMBER(38, 0),
    RETAIL_WEEK_NBR NUMBER(38, 0),
    RETAIL_WEEK_START_DT VARCHAR(16777216),
    RETAIL_WEEK_END_DT VARCHAR(16777216),
    RETAIL_MONTH_NBR NUMBER(38, 0),
    RETAIL_MONTH_START_DT VARCHAR(16777216),
    RETAIL_MONTH_END_DT VARCHAR(16777216),
    RETAIL_MONTH_DESC VARCHAR(16777216),
    RETAIL_QTR_NBR NUMBER(38, 0),
    RETAIL_QTR_DESC VARCHAR(16777216),
    RETAIL_QTR_START_DT VARCHAR(16777216),
    RETAIL_QTR_END_DT VARCHAR(16777216),
    RETAIL_SEASON_DESC VARCHAR(16777216),
    RETAIL_WEEK_SEASON_NBR NUMBER(38, 0),
    RETAIL_SEASON_NBR NUMBER(38, 0),
    RETAIL_SESN_START_DT VARCHAR(16777216),
    RETAIL_SESN_END_DT VARCHAR(16777216),
    RETAIL_YEAR_NBR NUMBER(38, 0),
    RETAIL_YEAR_START_DT VARCHAR(16777216),
    RETAIL_YEAR_END_DT VARCHAR(16777216),
    REPORTING_REGION_CD VARCHAR(16777216),
    REPORTING_REGION_SEGMENT_CD VARCHAR(16777216),
    MARKETPLACE_COUNTRY_NM VARCHAR(16777216),
    MARKETPLACE_ISO3_COUNTRY_CD VARCHAR(16777216),
    STORE_CD VARCHAR(16777216),
    STORE_GEO_NM VARCHAR(16777216),
    STORE_ENGLISH_NM VARCHAR(16777216),
    STORE_CITY_NM VARCHAR(16777216),
    STORE_CITY_TIER_NBR VARCHAR(16777216),
    STORE_GEOGRAPHY_REGION_NM VARCHAR(16777216),
    STORE_CHANNEL_ROLLUP_CD VARCHAR(16777216),
    STORE_DISTRICT_NM VARCHAR(16777216),
    STORE_TERRITORY_NM VARCHAR(16777216),
    STORE_POSTAL_CD VARCHAR(16777216),
    STORE_ERP_RETAIL_CONCEPT_CD VARCHAR(16777216),
    STORE_RETAIL_CONCEPT_DESC VARCHAR(16777216),
    CURRENCY_CD VARCHAR(16777216),
    MARKETPLACE_PLATFORM_CD VARCHAR(16777216),
    O2O_FLAG VARCHAR(16777216),
    REVENUE_RECOGNITION_DENOTATION VARCHAR(16777216),
    CONSUMER_DEMAND_GENERATION_DESC VARCHAR(16777216),
    CONSUMER_RETURN_LOCATION_DESC VARCHAR(16777216),
    ORDER_FULFILLMENT_METHOD_DESC VARCHAR(16777216),
    CONSUMER_COLLECTION_LOCATION_DESC VARCHAR(16777216),
    SHIP_TO_CITY_NM VARCHAR(16777216),
    SHIP_TO_STATE_CD VARCHAR(16777216),
    SHIP_TO_ZIP_CD VARCHAR(16777216),
    LINE_OF_BUSINESS_DESC VARCHAR(16777216),
    PRODUCT_UUID VARCHAR(16777216),
    PRODUCT_STYLE_CD VARCHAR(16777216),
    PRODUCT_CD VARCHAR(16777216),
    GTIN VARCHAR(16777216),
    NON_MERCH_IND NUMBER(38, 0),
    GIFT_CARD_IND NUMBER(38, 0),
    COMPLIMENTARY_IND NUMBER(38, 0),
    PRODUCT_FRANCHISE_NM VARCHAR(16777216),
    PRODUCT_COLOR_CD VARCHAR(16777216),
    PRODUCT_COLOR_DESC VARCHAR(16777216),
    PRODUCT_DIGITAL_DISPLAY_DESC VARCHAR(16777216),
    PRODUCT_CATEGORY_DESC VARCHAR(16777216),
    PRODUCT_UNIVERSAL_CATEGORY_DESC VARCHAR(16777216),
    PRODUCT_MERCHANDISING_CLASSIFICATION_DESC VARCHAR(16777216),
    PRODUCT_FRANCHISE_MERCH VARCHAR(16777216),
    PRODUCT_GENDER_DESC VARCHAR(16777216),
    PRODUCT_GENDER_AGE_DESC VARCHAR(16777216),
    PRODUCT_SILHOUETTE_DESC VARCHAR(16777216),
    PRODUCT_DIVISION_DESC VARCHAR(16777216),
    FIELDS_OF_PLAY_DESC VARCHAR(16777216),
    FIELDS_OF_PLAY_CODE VARCHAR(16777216),
    ORDER_ORIGIN VARCHAR(16777216),
    REPORTING_ORDER_ORIGIN_DESC VARCHAR(16777216),
    DEVICE VARCHAR(16777216),
    MARKETING_CHANNEL VARCHAR(16777216),
    CSR_IND NUMBER(38, 0),
    SEAMLESS_IND NUMBER(38, 0),
    PRODUCT_PLATFORM_DESC VARCHAR(16777216),
    PRODUCT_LEAGUE_NM VARCHAR(16777216),
    PRODUCT_TEAM_NM VARCHAR(16777216),
    PRODUCT_ATHLETE_NM VARCHAR(16777216),
    PRODUCT_PLANNING_DIVISION_NM VARCHAR(16777216),
    PRODUCT_PLANNING_AGE_GENDER_NM VARCHAR(16777216),
    PRODUCT_PLANNING_INTENDED_USE_NM VARCHAR(16777216),
    PRODUCT_PLANNING_STRUCTURE_NM VARCHAR(16777216),
    PRODUCT_PLANNING_SILHOUETTE_NM VARCHAR(16777216),
    PRODUCT_PLANNING_SUB_SILHOUETTE_NM VARCHAR(16777216),
    PRODUCT_BRAND_NM VARCHAR(16777216),
    PRODUCT_CONSUMER_CONSTRUCT_MWKJ VARCHAR(16777216),
    PRODUCT_CONSUMER_CONSTRUCT_SEGMENT_NM VARCHAR(16777216),
    PRODUCT_SUB_FAMILY_NM VARCHAR(16777216),
    PRODUCT_MODEL_NM VARCHAR(16777216),
    PRODUCT_CONSUMER_CONSTRUCT_DIMENSION_NM VARCHAR(16777216),
    PRODUCT_PLANNING_PERFORMANCE_ACTIVITY_NM VARCHAR(16777216),
    PRODUCT_PLANNING_PERFORMANCE_ACTIVITY_GROUP_NM VARCHAR(16777216),
    PRODUCT_PLANNING_FRANCHISE_PLANNING_PROGRAM_NM VARCHAR(16777216),
    PRODUCT_GLOBAL_REBUY_IND NUMBER(38, 0),
    PRICING_MSRP_PRC_USD NUMBER(38, 2),
    PRICING_MSRP_PRC NUMBER(38, 2),
    PRICING_CURRENT_SELLING_PRC_USD NUMBER(38, 2),
    PRICING_CURRENT_SELLING_PRC NUMBER(38, 2),
    VAT_TAX_AMT_USD NUMBER(38, 2),
    VAT_TAX_AMT NUMBER(38, 2),
    PRODUCT_STORE_REGULAR_ITEM_PRICE_USD NUMBER(38, 2),
    PRODUCT_STORE_REGULAR_ITEM_PRICE NUMBER(38, 2),
    TOTAL_GROSS_SALES_AMT_USD NUMBER(38, 2),
    TOTAL_GROSS_SALES_AMT NUMBER(38, 2),
    TOTAL_GROSS_SALES_QTY NUMBER(38, 0),
    TOTAL_CANCEL_AMT_USD NUMBER(38, 1),
    TOTAL_CANCEL_AMT NUMBER(38, 2),
    TOTAL_CANCEL_QTY NUMBER(38, 0),
    TOTAL_RETURN_AMT_USD NUMBER(38, 2),
    TOTAL_RETURN_AMT NUMBER(38, 2),
    TOTAL_RETURN_QTY NUMBER(38, 0),
    TOTAL_SHIPPED_AMT_USD NUMBER(38, 2),
    TOTAL_SHIPPED_AMT NUMBER(38, 2),
    TOTAL_SHIPPED_QTY NUMBER(38, 0),
    TOTAL_NET_SALES_AMT_USD NUMBER(38, 2),
    TOTAL_NET_SALES_AMT NUMBER(38, 2),
    TOTAL_NET_SALES_QTY NUMBER(38, 0),
    MARKDOWN_TOTAL_GROSS_SALES_AMT_USD NUMBER(38, 2),
    MARKDOWN_TOTAL_GROSS_SALES_AMT NUMBER(38, 2),
    PROMOTION_FULL_PRICE_GROSS_SALES_AMT_USD NUMBER(38, 2),
    PROMOTION_FULL_PRICE_GROSS_SALES_AMT NUMBER(38, 2),
    TOTAL_PROMO_GROSS_SALES_AMT_USD NUMBER(38, 0),
    TOTAL_PROMO_GROSS_SALES_AMT NUMBER(38, 0),
    COMPLIMENTARY_GROSS_SALES_AMT_USD NUMBER(38, 0),
    COMPLIMENTARY_GROSS_SALES_AMT NUMBER(38, 0),
    COMPLIMENTARY_GROSS_SALES_QTY NUMBER(38, 0),
