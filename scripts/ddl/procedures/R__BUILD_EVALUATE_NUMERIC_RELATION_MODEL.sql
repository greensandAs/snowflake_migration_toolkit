...
CREATE OR REPLACE PROCEDURE "BUILD_EVALUATE_NUMERIC_RELATION_MODEL"(
    "DATASET_NAME" VARCHAR, "FEATURE_LIST" ARRAY, "TARGET_COL" VARCHAR, "NUMERIC_COLS_ARRAY" ARRAY, "DATA_CONFIG" VARCHAR
)
RETURNS VARIANT
LANGUAGE PYTHON
